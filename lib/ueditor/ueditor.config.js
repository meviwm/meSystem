...
//        ,compressSide:1                           //等比压缩的基准，确定maxImageSideLength参数的参照对象。0为按照最长边，1为按照宽度，2为按照高度
        ,maxImageSideLength:500000                   //上传图片最大允许的边长，超过会自动等比缩放,不缩放就设置一个比较大的值，更多设置在image.html中
        ...
        ,filePath:""//这里修改为了空值                   //附件修正地址，同imagePath
        ...
        , toolbars:[
            [ 'source', '|', 'undo', 'redo', '|',
                ...
                'link', 'unlink', '|', 'imagenone', 'imageleft', 'imageright', 'imagecenter','wordimage', '|',
                'attachment','insertimage', 'emotion', 'background']
        ]
